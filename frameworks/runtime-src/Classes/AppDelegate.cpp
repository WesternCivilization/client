...
#include "Common/userdefine_OBBP_auto.hpp"
//#include "Common/ClientLog.h"
...
static int toLua_AppDelegate_xor(lua_State* tolua_S)
{
	int argc = lua_gettop(tolua_S);
	if (argc == 2)
	{
		int num1 = (int)lua_tonumber(tolua_S, 1);
		int num2 = (int)lua_tonumber(tolua_S, 2);
		lua_pushinteger(tolua_S, num1 ^ num2);  
		return 1;
	}
	return 0;
}
//static int toLua_AppDelegate_CLogInit(lua_State* tolua_S)
//{
//	int argc = lua_gettop(tolua_S);
//	if (argc == 2)
//	{
//		string str =  lua_tostring(tolua_S, 1);
//		int num2 = lua_tonumber(tolua_S, 2);
//		ClientLog* clienlog = ClientLog::getInstance();
//		clienlog->init(str, num2);
//		return 1;
//	}
//	return 0;
//}
//static int toLua_AppDelegate_CLogPrint(lua_State* tolua_S)
//{
//	int argc = lua_gettop(tolua_S);
//	if (argc == 1)
//	{
//		string str = lua_tostring(tolua_S, 1);
//		ClientLog::getInstance()->CppLog(str);
//		return 1;
//	}
//	return 0; 
//}
...
static int register_all_packages()
{
    ...
    register_all_recorder();
 	...
 	register_all_userdefine_OBBP(tolua_S);
	...
	lua_register(tolua_S, "Cxor", toLua_AppDelegate_xor);
//	lua_register(tolua_S, "CLogInit", toLua_AppDelegate_CLogInit);
//	lua_register(tolua_S, "CLogPrint", toLua_AppDelegate_CLogPrint);
...
bool AppDelegate::applicationDidFinishLaunching()
{
	...
	//added by cgp
// 	stack->addSearchPath("base/src/");
// 	stack->addSearchPath("client/");
// 	stack->addSearchPath("game/src/");
