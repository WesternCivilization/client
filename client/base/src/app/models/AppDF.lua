...
--每个游戏需要修改， 对应的发布release版本.bat中的重命名apk也要修改。
appdf.AppName = "668"
--
--大厅底包版本， 对应APK
appdf.BASE_C_VERSION = 1 --@app_version
--大厅资源版本
appdf.BASE_C_RESVERSION = 100   --@苹果商店审核从100开始，其他版本从1开始。

--是否是苹果企业版
appdf.isAppleEnterprice    =   0      --0：非企业版，   1：企业版, 在plist中配置

--是否是本地测试服务器
appdf.isLocalService  = 0     --    0： 正式服 get.668yx.com   1:本地测试服，114.

appdf.noOpenGame = ""     --未开发完成的游戏列表。

--自带游戏的版本号
appdf.BASE_GAME = 
{
	{kind = 101,version = "0"},     --四人牛牛
	{kind = 103,version = "0"},    --通比牛牛

}

 --appdf.req 使用的是绝对路径，除去根目录client，   
 --import 使用的是相对路径。E:\RYNewGame\668Mobile\client\base\src\app\MyApp.lua:
                           --local Version = import(".models.Version")   同级目录 就是.fileName
