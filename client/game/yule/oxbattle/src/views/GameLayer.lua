...
function GameLayer:returnGameList()
   self:KillGameClock()
    self:showPopWait()
  ...
  --          cc.DelayTime:create(10),
    ...
    --self._scene:onKeyBackGameList()  
    self._scene:onKeyBack()    --modified by cgp
end
...
function GameLayer:onEventGameMessage(sub, dataBuffer)
	if sub == Game_CMD.SUB_S_GAME_FREE then
        ...
        self._gameView:updateMaxJettonInfo()
 ...
 --       self._gameView:updateMax6Person()
