...
--		self.m_content:addChild(pimage)
        ...
        pimage:setPosition(StartX, StartY + (i-1)*SPACE)
		self.m_content:addChild(pimage)
        ...
        pimage:setPosition(StartX + SPACE, StartY + (i-1)*SPACE)
		self.m_content:addChild(pimage)
        ...
        pimage:setPosition(StartX + SPACE*2, StartY + (i-1)*SPACE)
		self.m_content:addChild(pimage)
        ...
        pimage:setPosition(StartX + SPACE*3, StartY + (i-1)*SPACE)
		self.m_content:addChild(pimage)  
	end
end
