...
function GameViewLayer:addGongGao(_cmd_table,_type)
      ...
      if _type == 2 and _cmd_table.nUserID ==meItem.dwGameID then
...
function GameViewLayer:showGongGao(cmd_table,ggtype)
    ...
    local colorT = {}
        ...
        if ggtype == 1 then
            strT = {cmd_table.wPlayName,"拍出",cmd_table.nGemCount,"连线",gem[cmd_table.nGemIndex + 1],",共赢得",cmd_table.lGemScore,"点数!"}
            ...
            strT = {cmd_table.wPlayName,"获得派发的彩金",cmd_table.lGemScore}
