...
function GameLayer:onEventGameSceneFree( dataBuffer )
    ...
    --游戏倒计时
    --self._gameView:startCountDown(cmd_table.cbTimeLeave, g_var(cmd).kGAMEFREE_COUNTDOWN);
...
function GameLayer:onEventGameSceneEnd( dataBuffer )
    ...
    --dump(cmd_table.lPlayBet, "cmd_table.lPlayBet", 6)
    --dump(cmd_table.lAllBet, "cmd_table.lAllBet", 6)
