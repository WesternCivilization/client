...
login.CMD_GP_UserInsureInfo = 
{
	...
	{k = "dwLoveCount", t = "dword"},                                   --魅力    added by cgp
}
...
login.SUB_GP_SEND_LOVE_LESS				    =   10							--赠送魅力 added by cgp
...
login.SUB_GP_LOVELESS_RESULT				=   110							--魅力返回 added by cgp
...
-- 赠送魅力返回结果(6, 110)
login.CMD_GP_S_LoveLess_Result = 
{
	-- 用户金币
	{t = "score", k = "lScore"},
	-- 银行存款
