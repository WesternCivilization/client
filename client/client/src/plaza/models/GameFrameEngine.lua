...
function GameFrameEngine:onLogonRoom()
	...
	print("\n\n登录房间："..self._roomInfo.szServerAddr.."#"..self._roomInfo.wServerPort)
...
function GameFrameEngine:onConnectCompeleted()
	...
	dataBuffer:setcmdinfo(yl.MDM_GR_LOGON,yl.SUB_GR_LOGON_MOBILE)   --主副消息1,2
...
function GameFrameEngine:onSocketLogonFinish()
	...
	if GlobalUserItem.bPrivateRoom and PriRoom then		 --私人房
