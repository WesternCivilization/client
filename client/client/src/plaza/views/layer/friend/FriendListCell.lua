...
function FriendListCell:ctor(dwID,superView)
    ...
    deleBtn:addTouchEventListener(function(ref, tType)
     ...
     deleBtn:setPosition(cc.p(879,self:getContentSize().height/2))
...
function FriendListCell:createCell(userInfo,index,contentView,superView)
    ...
    local head = PopupInfoHead:createClipHead(userInfo, 70)
    head:setPosition(cc.p(60,58))
    ...
    local yPos = defaultCellSize.height * 0.65
 ...
 --   nickName:setTextColor(cc.c4b(41,82,146,255));
    ...
    lValue:setPosition(cc.p(530,64))
...
--    end);
  ...
  --  userStatusLab:setTextColor(cc.c4b(88,94,101,255));
    ...
    userStatusLab:setPosition(cc.p(180,defaultCellSize.height * 0.35));
