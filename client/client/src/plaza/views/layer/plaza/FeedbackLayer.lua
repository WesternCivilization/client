...
function FeedbackListLayer:onTouchBegan (touch, event)
    return true
end
...
function FeedbackLayer:onTouchBegan (touch, event)
    return true
end
...
function FeedbackLayer:onButtonClickedEvent( tag, sender )
	...
	elseif BT_MYFEEDBACk == tag then
        self._scene:getNewTagLayer(yl.SCENE_FEEDBACKLIST)
	end
end
