...
local BagDetailLayer = class("BagDetailLayer", function(scene)
		local bagDetailLayer = display.newLayer(cc.c4b(0, 0, 0, 0))
...
function BagDetailLayer:ctor(scene, gameFrame)
	...
	self._txtNum1 = cc.LabelAtlas:_create("", "Bag/num_0.png", 20, 25, string.byte("/"))
    ...
    self._txtNum3:setPosition(cc.p(1170, 460))
